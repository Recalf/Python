...
in the "JobsHuntingScrape" script, you'll see that i used a module i named 'Captcha', its a module that i've spent quite a lot of time to create, with it, i can solve captcha v2 or v1 without using any subscription like 2captcha + I did some basic measures in it to not get detected as a bot while using the scraper
